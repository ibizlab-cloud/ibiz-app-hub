import { IMultiSeriesBarData } from '../interface';

// 条形图模型 MULTI_SERIES_BAR
export const MultiSeriesBarChartModel = {
  coordinateSystem: 'XY',
...
// 条形图属性配置
export const MultiSeriesBarChartConfig = {
  data: {
    details: [
      {
        id: 'measure',
...
// 条形图默认值
export const MultiSeriesBarDefaultData: IMultiSeriesBarData = {
  caption: '',
  data: {
    // 指标
    measure: undefined,
