import { IMultiSeriesLineData } from '../interface';

// 折线图模型 MULTI_SERIES_LINE
export const MultiSeriesLineChartModel = {
  coordinateSystem: 'XY',
...
// 折线图属性配置
export const MultiSeriesLineChartConfig = {
  data: {
    details: [
      {
        id: 'measure',
...
// 折线图默认值
export const MultiSeriesLineDefaultData: IMultiSeriesLineData = {
  caption: '',
  data: {
    // 指标
    measure: undefined,
