import { NOOP, listenJSEvent, OnClickOutsideResult } from '@ibiz-template/core';
import {
  GridRowState,
  GridFieldEditColumnController,
} from '@ibiz-template/runtime';
import { useClickOutside } from '@ibiz-template/vue3-util';
import { computed, reactive, Ref, onUnmounted, ref } from 'vue';
...
export function useCellEdit(
  ...
  cleanKeyUp = listenJSEvent(window, 'keyup', (e: KeyboardEvent) => {
