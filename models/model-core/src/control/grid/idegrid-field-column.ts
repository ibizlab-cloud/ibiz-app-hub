 ...
 * @export
 * @interface IDEGridFieldColumn
 */
export interface IDEGridFieldColumn extends IDEGridColumn {
  /**
   * 代码表输出模式
   ...
   *
   * @type {IEditor}
   * 来源  getFilterPSEditor
   */
  filterEditor?: IEditor;
  ...
  /**
   * 树列模式
   * @description 值模式 [实体表格树列模式] {0：无、 1：文本、 2：值、 3：文本及值、 8：父文本、 4：父值、 12：父文本及父值 }
   * @type {( number | 0 | 1 | 2 | 3 | 8 | 4 | 12)}
   * @default 0
   * 来源  getTreeColumnMode
   */
  treeColumnMode?: number | 0 | 1 | 2 | 3 | 8 | 4 | 12;
